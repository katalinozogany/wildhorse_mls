function [m_diff pval n_x1 n_x2] = randomisation_meandiff2(x1,x2,n)
...
% m_diff - difference btw the two means, pval - p from randomisation test
%
% the two samples are pooled, than divided again randomly, and mean
% difference is calculated in each iteration
% the statistic of mean difference will result the p for experimental data
